...
(function (root, factory) {
  ...
  const en = {
    ...
    'okb.sync': 'ALSO TURN OPENKNEEBOARD PAGES',
    'okb.found': 'ONE KEY PAGES BOTH KNEEBOARDS',
    'okb.missing': 'OPENKNEEBOARD NOT FOUND ON THIS PC',
  ...
  const it = {
    ...
    'okb.sync': 'GIRA ANCHE LE PAGINE DI OPENKNEEBOARD',
    'okb.found': 'UN TASTO GIRA ENTRAMBE LE KNEEBOARD',
    'okb.missing': 'OPENKNEEBOARD NON TROVATO SU QUESTO PC',
