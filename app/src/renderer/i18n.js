...
(function (root, factory) {
  ...
  const en = {
    ...
    'up.installed': 'INSTALLED',
    'up.latest': 'LATEST',
    'up.checking': 'CHECKING…',
    'up.current': 'UP TO DATE',
    'up.ready': '{v} READY',
    'up.downloading': 'DOWNLOADING {n}%',
    'up.failed': 'COULD NOT CHECK',
    'up.unsupported': 'WINDOWS ONLY',
    'up.actCheck': 'CHECK FOR UPDATES',
    'up.actChecking': 'CHECKING…',
    'up.actDownload': 'DOWNLOAD {v}',
    'up.actDownloading': 'DOWNLOADING…',
  ...
  const it = {
    ...
    'cap.update': 'Versione',
    'cap.whatsNew': 'Novità',
    'up.installed': 'INSTALLATA',
    'up.latest': 'ULTIMA',
    'up.checking': 'CONTROLLO…',
    'up.current': 'AGGIORNATO',
    'up.ready': '{v} PRONTA',
    'up.downloading': 'SCARICO {n}%',
    'up.failed': 'CONTROLLO FALLITO',
    'up.unsupported': 'SOLO WINDOWS',
    'up.actCheck': 'CONTROLLA AGGIORNAMENTI',
    'up.actChecking': 'CONTROLLO…',
    'up.actDownload': 'SCARICA {v}',
    'up.actDownloading': 'SCARICO…',
