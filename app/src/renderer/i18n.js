...
(function (root, factory) {
  ...
  const en = {
    ...
    // Updates. The release notes themselves are the author's words from a
    // GitHub release and are never translated; everything the app says is.
    'rail.update': 'UPDATE',
    'cap.currentVersion': 'Current version',
    'cap.whatsNew': "What's new",
    'up.actCheck': 'CHECK FOR UPDATES',
    'up.actChecking': 'CHECKING…',
    'up.actDownload': 'DOWNLOAD {v}',
    'up.actDownloading': 'DOWNLOADING {n}%',
    'up.actRestart': 'RESTART TO INSTALL',
    'up.hintIdle': 'CHECKED WHEN THE APP STARTS',
    'up.hintCurrent': 'YOU ARE ON THE NEWEST RELEASE',
    'up.hintAvailable': 'NOTHING DOWNLOADS UNTIL YOU PRESS IT',
    'up.hintDownloading': 'ONLY THE CHANGED PARTS ARE FETCHED',
    'up.hintReady': 'INSTALLS ON RESTART — NEVER MID-FLIGHT',
    'up.hintFailed': 'NO NETWORK, OR GITHUB IS UNREACHABLE',
    'up.hintUnsupported': 'MAC BUILDS ARE UNSIGNED AND CANNOT SELF-UPDATE',
    ...
    'card.edit': 'EDIT THE CARD',
    'card.editStop': 'STOP EDITING',
    'card.export': 'EXPORT AS A FILE',
    'card.rows': '{n} OF {max}',
    'card.addRow': '+ ROW',
    'card.removeRow': 'REMOVE ROW {n}',
    'view.card': 'THE SHEET',
    'view.templates': 'TEMPLATES',
    'tpl.import': 'IMPORT A TEMPLATE',
    'tpl.shipped': 'SHIPPED WITH TAC LINK',
    'tpl.yours': 'YOURS',
    ...
    'tpl.id': 'ID',
    'tpl.pages': 'PAGES',
    'tpl.remove': 'REMOVE {name}',
    'tpl.name': 'NAME THIS TEMPLATE',
    'tpl.nameReplace': 'REPLACE THIS TEMPLATE',
    'tpl.nameLabel': 'NAME',
    'tpl.cancel': 'CANCEL',
    'tpl.save': 'SAVE',
    'tpl.refused': 'NOT IMPORTED',
    'tpl.refusedWhy': 'A TEMPLATE THAT SHIPS BROKEN BREAKS ON A KNEE. NOTHING HAS CHANGED.',
    'card.blank': 'NO DATA LOADED',
    'card.blankWhy': 'LOAD A CARD TO FILL THIS TEMPLATE',
    'card.sent': 'CARD SENT',
  ...
  const it = {
    ...
    'card.edit': 'MODIFICA LA CARD',
    'card.editStop': 'FERMA LA MODIFICA',
    'card.export': 'ESPORTA COME FILE',
    'card.rows': '{n} DI {max}',
    'card.addRow': '+ RIGA',
    'card.removeRow': 'RIMUOVI RIGA {n}',
    'view.card': 'IL FOGLIO',
    'view.templates': 'MODELLI',
    'tpl.import': 'IMPORTA UN MODELLO',
    'tpl.shipped': 'INCLUSI IN TAC LINK',
    'tpl.yours': 'I TUOI',
    'tpl.none': 'NESSUN MODELLO',
    'tpl.inUse': 'IN USO',
    'tpl.blocks': '{n} BLOCCHI',
    'tpl.needs': 'RICHIEDE',
    'tpl.id': 'ID',
    'tpl.pages': 'PAGINE',
    'tpl.remove': 'RIMUOVI {name}',
    'tpl.name': 'DAI UN NOME A QUESTO MODELLO',
    'tpl.nameReplace': 'SOSTITUISCI QUESTO MODELLO',
    'tpl.nameLabel': 'NOME',
    'tpl.cancel': 'ANNULLA',
    'tpl.save': 'SALVA',
    'tpl.refused': 'NON IMPORTATO',
    'tpl.refusedWhy': 'UN MODELLO DIFETTOSO SI ROMPE IN VOLO. NULLA È CAMBIATO.',
    'card.blank': 'NESSUN DATO CARICATO',
    'card.blankWhy': 'CARICA UNA CARD PER RIEMPIRE QUESTO MODELLO',
    'card.sent': 'CARD INVIATA',
    'card.sentTo': 'A {n} IN RETE',
    'brief.present': 'PRESENTA — TRASMETTI ALLA FORMAZIONE',
    'rail.update': 'UPDATE',
    'cap.currentVersion': 'Versione attuale',
    'cap.whatsNew': 'Novità',
    'up.actCheck': 'CONTROLLA AGGIORNAMENTI',
    'up.actChecking': 'CONTROLLO…',
    'up.actDownload': 'SCARICA {v}',
    'up.actDownloading': 'SCARICO {n}%',
    'up.actRestart': 'RIAVVIA PER INSTALLARE',
    'up.hintIdle': 'CONTROLLATO ALL\'AVVIO',
    'up.hintCurrent': 'SEI SULL\'ULTIMA RELEASE',
    'up.hintAvailable': 'NON SCARICA NULLA FINCHÉ NON PREMI',
    'up.hintDownloading': 'SCARICA SOLO LE PARTI CAMBIATE',
    'up.hintReady': 'SI INSTALLA AL RIAVVIO — MAI IN VOLO',
    'up.hintFailed': 'NESSUNA RETE, O GITHUB IRRAGGIUNGIBILE',
    'up.hintUnsupported': 'LE BUILD MAC NON SONO FIRMATE',
